...
class TestPerevalsEndpoint:
    ...
    def test_post_key_error(self, api_client):
        ...
        response = api_client.post(self.url, values_without_secondary_info, format="json")
...
class TestPerevalDetailEndpoint:
    ...
    @pytest.mark.django_db
    def test_get(self, api_client, test_post_values, populate_db):
    ...
    @pytest.mark.django_db
    def test_patch_wrong_type(self, api_client, populate_db, test_post_values):
        wrong_type = {
    ...
    @pytest.mark.django_db
    def test_patch_no_id_for_image(self, api_client, populate_db):
        no_id_images = {
    ...
    @pytest.mark.django_db
    def test_patch_change_coords_info(self, api_client, populate_db):
        partial_coords = {
    ...
    @pytest.mark.django_db
    def test_patch_change_level_info(self, api_client, populate_db):
        partial_level = {
            "level": {"winter": "2A"}
        }
    ...
    @pytest.mark.django_db
    def test_patch_change_images_info(self, api_client, populate_db):
        partial_images = {
            "images": [{"id": 1,
                        "title": "test_change"}]
        }
    ...
    @pytest.mark.django_db
    def test_patch_change_status_if_status_is_new(self, api_client, populate_db):
        change_status = {
            "status": "accepted"
        }
    ...
    @pytest.mark.django_db
    def test_patch_change_if_status_is_not_new(self, api_client, populate_db):
        any_info_to_change = {
            "title": "test_change"
        }
        change_status = {
...
class TestPerevalQueryEndpoint:
    ...
    def test_get_objects_with_email(self, api_client, test_post_values):
        ...
        api_client.post(reverse('passes'), test_post_values, format="json")
        api_client.post(reverse('passes'), test_post_values, format="json")
